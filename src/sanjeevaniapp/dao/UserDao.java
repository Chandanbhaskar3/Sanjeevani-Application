...
public class UserDao {
    ...
    // delete employee and doctor frame
    public static void deleteUserByName(String docName) throws SQLException {
         Connection conn = DBConnection.getConnection();
     ...
     public static void deleteUserByRecName(String recepName) throws SQLException {
         Connection conn = DBConnection.getConnection();
         PreparedStatement ps = conn.prepareStatement("delete from users where user_name = ?");
...
//     public static void updateUserByUserName(String userName,String loginId,String mob,String opds) throws SQLException {
//         Connection conn = DBConnection.getConnection();
//         PreparedStatement ps = conn.prepareStatement("update users set loginId = ? , mobile_no = ?, opd = ? where userName = ?");
